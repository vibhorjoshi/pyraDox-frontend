...
import requests
import json
from api_sample import hit_api_validate,hit_api_extract,hit_api_mask_aadhaar,hit_api_brut_mask,hit_api_sample_pipe
from app import ocr,validate,mask,brut_mask
